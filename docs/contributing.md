...
1. **Consult the agent(s)** for your target files. Read their agent files.
2. **Open a PR** with a conventional commit title (`feat:`, `fix:`, etc).
3. **Describe agent consultation** in your PR description: `Consulted: <agent-name> per routing matrix`.
4. **Pass all required checks** — agent reviews, QA, security, CI.
